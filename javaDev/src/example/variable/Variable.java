...
public class Variable {
	public void initVariable() {
		...
		//문자형 : 2byte
		char ch = 'A'; //싱글 쿼테이션 사용하여 리텉럴 입력
		// 하나의 문자만 대입 가능

		//문자열 : 참조형(주소값을 저장)
		String str = "안녕하세요"; // 더블 쿼테이션을 사용하여
	...
	public void changeValue(){
		...
		//키보드로 값을 입력받아 변수에 저장된값을 변경한다.
		Scanner sc = new Scanner(System.in);

		System.out.print("이름을 입력하세요 : " );
		name = sc.nextLine();
		System.out.print("성별을 입력하세요 : " );
		gender = sc.next().charAt(0); //문자를 읽어오는 메서드를 제공하지 않기때문
	...
	public void testOverflow() {
		...
		//byte bnum = 128;  //저장 가능 범위 벗어나므로 에러 발생
		...
		bnum = -128;
		bnum -= 1;
		System.out.println("byte의  최솟값 - 1 : "+ bnum);
	...
	public void testCasting2() {
		...
		//byte or short의 결과를 얻기 위해 강제 형변화
